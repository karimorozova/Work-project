<template lang="pug">
    .marketing
        FormWrapper
            RequestForm(:service="service" :isMarketing="true" @checkErrors="checkErrors")
        OrderInfo(
            service="Marketing"
            :isDuo="false"
            :isCopywriting="true"
...
export default {
    ...
    methods: {
        ...
        async checkErrors() {
            ...
            if(!this.orderDetails.genBrief['Targeted Audience']) this.errors.push('Fill the Targeted audience field');
