    ...
    .test(v-if="!isShowTemplateStep")
      .component__body(v-if="!isSent")
        .component__form
          ...
          //  )
          .form__submit
            Button(@clicked="checkError" :isDisabled="isRequestNow" value="Submit" )
...
export default {
  ...
  methods: {
    ...
    async addService() {
      ...
      formData.append('notes', this.selectedInstructions.length ? JSON.parse(this.selectedInstructions).map(({
                                                                                                               description,
                                                                                                               title
