...
export const getAllOpenProjects = state => state.openProjects;
export const getAllRequests = state => state.requests;
export const getAllOpenRequests = state => state.openRequests;
export const getAllOpenQuotes = state => state.openQuotes;
