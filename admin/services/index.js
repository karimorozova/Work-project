...
const { getXtmCustomers,saveTasks, saveTemplateTasks, getMetrics, 
    createNewXtmCustomer, getRequestOptions, getTaskProgress, 
    generateTargetFile, getEditorUrl, getAnalysis, getXtmFileStatus } = require("./xtmApi");
