	...
	return `<div class="wrapper" style="width:800px;border-width:1px;border-style:solid;border-color:#bfbfbf;font-family:'Roboto', sans-serif;color:#333!important;box-sizing:border-box;" >
                ...
                <div class="main" style="padding:25px;" >
                   <p style="background: #f7f7f7; font-size: 14px; font-weight: bold; padding: 14px;"><span id="client-name-row">Dear ${ obj.firstName }</span></p>
                   	...
                   	<a href="https://admin2.pangea.global/pangea-projects/all-projects/All/details/${ obj._id }" target="_blank">${ obj.projectId } - ${ obj.projectName }</a>
...
function managerTaskCompleteNotificationMessage(obj, user) {
	return `<div class="wrapper" style="width:800px;border-width:1px;border-style:solid;border-color:#bfbfbf;font-family:'Roboto', sans-serif;color:#333!important;box-sizing:border-box;" >
                ...
                <div class="main" style="padding:25px;" >
                    ...
                    <p style="font-weight: 400;">
                        Task ${ obj.task.taskId } from project <a href="https://admin2.pangea.global/pangea-projects/all-projects/All/details/${ obj._id }" target="_blank">${ obj.projectId } - ${ obj.projectName } </a>  is completed and ready for DR1.
                    </p>
                    <p style="font-weight: 400;">
...
function deliverablesDownloadedMessage(obj, user) {
	...
	return `<div class="wrapper" style="width:800px;border-width:1px;border-style:solid;border-color:#bfbfbf;font-family:'Roboto', sans-serif;color:#333!important;box-sizing:border-box;" >
                ...
                <div class="main" style="padding:25px;" >
                    ...
                    <p style="font-weight: 400;">
                        Task ${ obj.taskId } from project  <a href="https://admin2.pangea.global/pangea-projects/all-projects/All/details/${ obj._id }" target="_blank">${ obj.project_id } - ${ obj.projectName }</a>  has been reviewed and delivered by ${ user.firstName } ${ user.lastName || "" }
                    </p>
                </div>
                <footer>
                    <hr size="10" style="border:none;" color="#efefef">
                ...
                <div class="main" style="padding:25px;" >
                    ...
                    <p>
                    	This email is to confirm that quote <b>${ obj.projectId } - ${ obj.projectName }</b> has been accepted.
										...
										<p>
                    	Pls click <a href="https://portal2.pangea.global/dashboard/details/${ obj.nativeProjectId }" target="_blank">here</a> to enter the project in <b>αlfα by Pangea</b> portal
										</p>
                </div>
                <footer>
                    <hr size="10" style="border:none;" color="#efefef">
...
function stepStartedMessage(obj, user) {
	...
	return `<div class="wrapper" style="width:800px;border-width:1px;border-style:solid;border-color:#bfbfbf;font-family:'Roboto', sans-serif;color:#333!important;box-sizing:border-box;" >
                ...
                <div class="main" style="padding:25px;" >
                   	<p style="background: #f7f7f7; font-size: 14px; font-weight: bold; padding: 14px;"><span id="client-name-row">Dear ${ user.firstName }</span></p>
                    <p style="font-weight: 400;">
                        Vendor ${ obj.step.vendor.firstName } ${ vendorSurname } just start the step: ${ obj.step.stepId } from <a href="https://admin2.pangea.global/pangea-projects/all-projects/All/details/${ obj._id }" target="_blank">${ obj.projectId } - ${ obj.projectName }</a>
                    </p>
                    <p style="font-weight: 400;">
...
function stepCompletedMessage(obj, user) {
	...
	return `<div class="wrapper" style="width:800px;border-width:1px;border-style:solid;border-color:#bfbfbf;font-family:'Roboto', sans-serif;color:#333!important;box-sizing:border-box;" >
                ...
                <div class="main" style="padding:25px;" >
                    <p style="background: #f7f7f7; font-size: 14px; font-weight: bold; padding: 14px;"><span id="client-name-row">Dear ${ user.firstName }</span></p>
                    <p style="font-weight: 400;">
                        Vendor ${ obj.step.vendor.firstName } ${ vendorSurname } just completed the step: ${ obj.step.stepId } from <a href="https://admin2.pangea.global/pangea-projects/all-projects/All/details/${ obj._id }" target="_blank">${ obj.projectId } - ${ obj.projectName }</a>
                    </p>
                </div>
                <footer>
                    <hr size="10" style="border:none;" color="#efefef">
...
function stepDecisionMessage(obj, user) {
	...
	return `<div class="wrapper" style="width:800px;border-width:1px;border-style:solid;border-color:#bfbfbf;font-family:'Roboto', sans-serif;color:#333!important;box-sizing:border-box;" >
                ...
                <div class="main" style="padding:25px;" >
                    ...
                    <p style="font-weight: 400;">
                    	from project: <a href="https://admin2.pangea.global/pangea-projects/all-projects/All/details/${ obj.project._id }" target="_blank">${ obj.project.projectId } - ${ obj.project.projectName }</a>
										</p>
...
function readyForDr2Message(obj, user) {
	return `<div class="wrapper" style="width:800px;border-width:1px;border-style:solid;border-color:#bfbfbf;font-family:'Roboto', sans-serif;color:#333!important;box-sizing:border-box;" >
                ...
                <div class="main" style="padding:25px;" >
                    <p style="background: #f7f7f7; font-size: 14px; font-weight: bold; padding: 14px;"><span id="client-name-row">Dear ${ user.firstName }</span></p>
                    <p style="font-weight: 400;">
                        The Delivery Review for ${ obj.taskId } from project <a href="https://admin2.pangea.global/pangea-projects/all-projects/All/details/${ obj._id }" target="_blank">${ obj.projectId } - ${ obj.projectName }</a> has been finished. 
                    </p>
                    <p style="font-weight: 400;">
	...
	return `<div class="wrapper" style="width:800px;border-width:1px;border-style:solid;border-color:#bfbfbf;font-family:'Roboto', sans-serif;color:#333!important;box-sizing:border-box;" >
                ...
                <div class="main" style="padding:25px;" >
                    <p style="font-width: 400;">
                    	Delivery review of the task <a href="https://admin2.pangea.global/pangea-projects/all-projects/All/details/${ projectId }" target="_blank"> ${ taskId }</a> is assigned to you.
                    </p>
                </div>
                <footer>
                    <hr size="10" style="border:none;" color="#efefef">
...
function managerDr1Reassign(obj, DRNumber) {
	return `<div class="wrapper" style="width:800px;border-width:1px;border-style:solid;border-color:#bfbfbf;font-family:'Roboto', sans-serif;color:#333!important;box-sizing:border-box;" >
                ...
                <div class="main" style="padding:25px;" >
                    ...
                    <p style="font-width: 400;">
                        The Delivery Review ${ DRNumber } for ${ obj.taskId } from project <a href="https://admin2.pangea.global/pangea-projects/all-projects/All/details/${ obj.project._id }" target="_blank">${ obj.project.projectId } - ${ obj.project.projectName }</a> has been reassigned to ${ obj.manager.firstName } ${ obj.manager.lastName || "" }.
                    </p>
                </div>
                <footer>
                    <hr size="10" style="border:none;" color="#efefef">
...
function managerDr1Assigned(obj, DRNumber) {
	...
	return `<div class="wrapper" style="width:800px;border-width:1px;border-style:solid;border-color:#bfbfbf;font-family:'Roboto', sans-serif;color:#333!important;box-sizing:border-box;" >
                ...
                <div class="main" style="padding:25px;" >
                    <p style="background: #f7f7f7; font-size: 14px; font-weight: bold; padding: 14px;"><span id="client-name-row">Dear ${ obj.manager.firstName } ${ lastName }</span></p>
                    <p style="font-weight: 400;">
                        Delivery review ${ DRNumber } for ${ obj.taskId } from project <a href="https://admin2.pangea.global/pangea-projects/all-projects/All/details/${ obj.project._id }" target="_blank">${ obj.project.projectId } - ${ obj.project.projectName }</a> has been assigned to you.
                    </p>
                    <p style="font-weight: 400;">
...
function severalDr1Assign(obj) {
	...
	return `<div class="wrapper" style="width:800px;border-width:1px;border-style:solid;border-color:#bfbfbf;font-family:'Roboto', sans-serif;color:#333!important;box-sizing:border-box;" >
                ...
                <div class="main" style="padding:25px;" >
                    ...
                    <p style="font-width: 400;">
                        DR1 for project <a href="https://admin2.pangea.global/pangea-projects/all-projects/All/details/${ obj.project._id }" target="_blank">${ obj.project.projectId } - ${ obj.project.projectName }</a> 
...
function severalDr1reAssign(obj) {
	...
	return `<div class="wrapper" style="width:800px;border-width:1px;border-style:solid;border-color:#bfbfbf;font-family:'Roboto', sans-serif;color:#333!important;box-sizing:border-box;" >
                ...
                <div class="main" style="padding:25px;" >
                		<p style="background: #f7f7f7; font-size: 14px; font-weight: bold; padding: 14px;"><span id="client-name-row">Dear ${ obj.prevManager.firstName } ${ obj.prevManager.lastName || "" }</span></p>
                    <p style="font-width: 400;">
                        DR1 from project <a href="https://admin2.pangea.global/pangea-projects/all-projects/All/details/${ obj.project._id }" target="_blank">${ obj.project.projectId } - ${ obj.project.projectName }</a> 
	...
	return `<div class="wrapper" style="width:800px;border-width:1px;border-style:solid;border-color:#bfbfbf;font-family:'Roboto', sans-serif;color:#333!important;box-sizing:border-box;" >
                ...
                <div class="main" style="padding:25px;" >
                   <p style="background: #f7f7f7; font-size: 14px; font-weight: bold; padding: 14px;"><span id="client-name-row">Dear ${ user.firstName } ${ user.lastName || '' }</span></p>
                    <p style="font-weight: 400;">
                        Incoming request: <a href="https://admin2.pangea.global/pangea-projects/requests/details/${ request._id }" target="_blank">${ request.projectId } - ${ request.projectName }</a> 
	...
	return `<div class="wrapper" style="width:800px;border-width:1px;border-style:solid;border-color:#bfbfbf;font-family:'Roboto', sans-serif;color:#333!important;box-sizing:border-box;" >
                ...
                <div class="main" style="padding:25px;" >
                   <p style="background: #f7f7f7; font-size: 14px; font-weight: bold; padding: 14px;"><span id="client-name-row">Dear ${ request.projectManager.firstName } ${ request.projectManager.lastName || '' }</span></p>
                    <p style="font-weight: 400;">
                        Incoming request: <a href="https://admin2.pangea.global/pangea-projects/requests/am-requests/Request_Approved/details/${ request._id }" target="_blank">${ request.projectId } - ${ request.projectName }</a> 
