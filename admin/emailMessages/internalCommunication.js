	...
	return `<div class="wrapper" style="width:800px;border-width:1px;border-style:solid;border-color:rgb(129, 129, 129);font-family:'Roboto', sans-serif;color:#66563E;box-sizing:border-box;" >
                ...
                <div class="main" style="padding-top:20px;padding-bottom:20px;padding-right:20px;padding-left:20px;" >
                   <p style="background: #F4F0EE; font-size: 14px; font-weight: bold; padding: 14px;"><span id="client-name-row">Dear ${ obj.user.firstName }</span></p>
                    <p style="font-weight: 400;">
                        Quote  <a href="https://admin.pangea.global/projects/details/${obj._id}" target="_blank" style="color: #D15F45">${ obj.projectId } - ${ obj.projectName }</a> has been accepted. Please, assign Vendor(s) for the task(s) to start project.
                    </p>
                </div>
                <footer>
                    <hr size="15" color="#66563E">
...
function managerTaskCompleteNotificationMessage(obj, user) {
	return `<div class="wrapper" style="width:800px;border-width:1px;border-style:solid;border-color:rgb(129, 129, 129);font-family:'Roboto', sans-serif;color:#66563E;box-sizing:border-box;" >
                ...
                <div class="main" style="padding-top:20px;padding-bottom:20px;padding-right:20px;padding-left:20px;" >
                    ...
                    <p style="font-weight: 400;">
                        Task ${ obj.task.taskId } from project <a href="https://admin.pangea.global/projects/details/${obj._id}" target="_blank" style="color: #D15F45">${ obj.projectId } - ${ obj.projectName } </a>  is completed and ready for DR1.
                    </p>
                    <p style="font-weight: 400;">
...
function deliverablesDownloadedMessage(obj, user) {
	...
	return `<div class="wrapper" style="width:800px;border-width:1px;border-style:solid;border-color:rgb(129, 129, 129);font-family:'Roboto', sans-serif;color:#66563E;box-sizing:border-box;" >
                ...
                <div class="main" style="padding-top:20px;padding-bottom:20px;padding-right:20px;padding-left:20px;" >
                    ...
                    <p style="font-weight: 400;">
                        Task ${ obj.taskId } from project  <a href="https://admin.pangea.global/projects/details/${obj._id}" target="_blank" style="color: #D15F45">${ obj.project_id } - ${ obj.projectName}</a>  has been reviewed and delivered by ${user.firstName} ${user.lastName || ""}
                    </p>
                </div>
                <footer>
                    <hr size="15" color="#66563E">
...
function managerProjectAcceptedMessage(obj) {
	return `<div class="wrapper" style="width:800px;border-width:1px;border-style:solid;border-color:rgb(129, 129, 129);font-family:'Roboto', sans-serif;color:#66563E;box-sizing:border-box;" >
                ...
                <div class="main" style="padding-top:20px;padding-bottom:20px;padding-right:20px;padding-left:20px;" >
                    ...
                    <p>
                        Client ${ obj.customer.name } has just accepted quote:  <a href="https://admin.pangea.global/projects/details/${obj._id}" target="_blank" style="color: #D15F45">${ obj.projectId } - ${ obj.projectName }</a>
                    </p>
                    <p>
...
function managerProjectRejectedMessage(obj) {
	return `<div class="wrapper" style="width:800px;border-width:1px;border-style:solid;border-color:rgb(129, 129, 129);font-family:'Roboto', sans-serif;color:#66563E;box-sizing:border-box;" >
            ...
            <div class="main" style="padding-top:20px;padding-bottom:20px;padding-right:20px;padding-left:20px;" >
                ...
                <p>
                    Client ${ obj.customer.name } has just rejected quote: <a href="https://admin.pangea.global/projects/details/${obj._id}" target="_blank" style="color: #D15F45">${ obj.projectId } - ${ obj.projectName }</a>
                </p>
                <p>
...
function stepStartedMessage(obj, user) {
	...
	return `<div class="wrapper" style="width:800px;border-width:1px;border-style:solid;border-color:rgb(129, 129, 129);font-family:'Roboto', sans-serif;color:#66563E;box-sizing:border-box;" >
                ...
                <div class="main" style="padding-top:20px;padding-bottom:20px;padding-right:20px;padding-left:20px;" >
                   	<p style="background: #F4F0EE; font-size: 14px; font-weight: bold; padding: 14px;"><span id="client-name-row">Dear ${ user.firstName }</span></p>
                    <p style="font-weight: 400;">
                        Vendor ${ obj.step.vendor.firstName } ${ vendorSurname } just start the step: ${ obj.step.stepId } from <a href="https://admin.pangea.global/projects/details/${obj._id}" target="_blank" style="color: #D15F45">${ obj.projectId } - ${ obj.projectName }</a>
                    </p>
                    <p style="font-weight: 400;">
...
function stepCompletedMessage(obj, user) {
	...
	return `<div class="wrapper" style="width:800px;border-width:1px;border-style:solid;border-color:rgb(129, 129, 129);font-family:'Roboto', sans-serif;color:#66563E;box-sizing:border-box;" >
                ...
                <div class="main" style="padding-top:20px;padding-bottom:20px;padding-right:20px;padding-left:20px;" >
                    <p style="background: #F4F0EE; font-size: 14px; font-weight: bold; padding: 14px;"><span id="client-name-row">Dear ${ user.firstName }</span></p>
                    <p style="font-weight: 400;">
                        Vendor ${ obj.step.vendor.firstName } ${ vendorSurname } just completed the step: ${ obj.step.stepId } from <a href="https://admin.pangea.global/projects/details/${obj._id}" target="_blank" style="color: #D15F45">${ obj.projectId } - ${ obj.projectName }</a>
                    </p>
                </div>
                <footer>
                    <hr size="15" color="#66563E">
...
function stepDecisionMessage(obj, user) {
	...
	return `<div class="wrapper" style="width:800px;border-width:1px;border-style:solid;border-color:rgb(129, 129, 129);font-family:'Roboto', sans-serif;color:#66563E;box-sizing:border-box;" >
                ...
                <div class="main" style="padding-top:20px;padding-bottom:20px;padding-right:20px;padding-left:20px;" >
                 		<p style="background: #F4F0EE; font-size: 14px; font-weight: bold; padding: 14px;"><span id="client-name-row">Dear ${ user.firstName }</span></p>
                    <p style="font-weight: 400;">
                        Vendor ${ obj.step.vendor.firstName } ${ vendorSurname } has ${ decision } the assigned step: ${ obj.step.stepId } from <a href="https://admin.pangea.global/projects/details/${obj.project._id}" target="_blank" style="color: #D15F45">${ obj.project.projectId } - ${ obj.project.projectName }</a>
                    </p>
...
function readyForDr2Message(obj, user) {
	return `<div class="wrapper" style="width:800px;border-width:1px;border-style:solid;border-color:rgb(129, 129, 129);font-family:'Roboto', sans-serif;color:#66563E;box-sizing:border-box;" >
                ...
                <div class="main" style="padding-top:20px;padding-bottom:20px;padding-right:20px;padding-left:20px;" >
                    <p style="background: #F4F0EE; font-size: 14px; font-weight: bold; padding: 14px;"><span id="client-name-row">Dear ${ user.firstName }</span></p>
                    <p style="font-weight: 400;">
                        The Delivery Review for ${ obj.taskId } from project <a href="https://admin.pangea.global/projects/details/${obj._id}" target="_blank" style="color: #D15F45">${ obj.projectId } - ${ obj.projectName }</a> has been finished. 
                    </p>
                    <p style="font-weight: 400;">
	...
	return `<div class="wrapper" style="width:800px;border-width:1px;border-style:solid;border-color:rgb(129, 129, 129);font-family:'Roboto', sans-serif;color:#66563E;box-sizing:border-box;" >
                ...
                <div class="main" style="padding-top:20px;padding-bottom:20px;padding-right:20px;padding-left:20px;" >
                    <p style="font-width: 400;">
                    	Delivery review of the task <a href="https://admin.pangea.global/projects/details/${projectId}" target="_blank" style="color: #D15F45"> ${ taskId }</a> is assigned to you.
                    </p>
                </div>
                <footer>
                    <hr size="15" color="#66563E">
...
function managerDr1Reassign(obj, DRNumber) {
	return `<div class="wrapper" style="width:800px;border-width:1px;border-style:solid;border-color:rgb(129, 129, 129);font-family:'Roboto', sans-serif;color:#66563E;box-sizing:border-box;" >
                ...
                <div class="main" style="padding-top:20px;padding-bottom:20px;padding-right:20px;padding-left:20px;" >
                    ...
                    <p style="font-width: 400;">
                        The Delivery Review ${DRNumber} for ${ obj.taskId } from project <a href="https://admin.pangea.global/projects/details/${obj.project._id}" target="_blank" style="color: #D15F45">${ obj.project.projectId } - ${ obj.project.projectName }</a> has been reassigned to ${ obj.manager.firstName } ${ obj.manager.lastName || "" }.
                    </p>
                </div>
                <footer>
                    <hr size="15" color="#66563E">
...
function managerDr1Assigned(obj, DRNumber) {
	...
	return `<div class="wrapper" style="width:800px;border-width:1px;border-style:solid;border-color:rgb(129, 129, 129);font-family:'Roboto', sans-serif;color:#66563E;box-sizing:border-box;" >
                ...
                <div class="main" style="padding-top:20px;padding-bottom:20px;padding-right:20px;padding-left:20px;" >
                    <p style="background: #F4F0EE; font-size: 14px; font-weight: bold; padding: 14px;"><span id="client-name-row">Dear ${ obj.manager.firstName } ${ lastName }</span></p>
                    <p style="font-weight: 400;">
                        Delivery review ${DRNumber} for ${ obj.taskId } from project <a href="https://admin.pangea.global/projects/details/${obj.project._id}" target="_blank" style="color: #D15F45">${ obj.project.projectId } - ${ obj.project.projectName }</a> has been assigned to you.
                    </p>
                    <p style="font-weight: 400;">
...
function severalDr1Assign(obj) {
	...
	return `<div class="wrapper" style="width:800px;border-width:1px;border-style:solid;border-color:rgb(129, 129, 129);font-family:'Roboto', sans-serif;color:#66563E;box-sizing:border-box;" >
                ...
                <div class="main" style="padding-top:20px;padding-bottom:20px;padding-right:20px;padding-left:20px;" >
                    ...
                    <p style="font-width: 400;">
                        DR1 for project <a href="https://admin.pangea.global/projects/details/${obj.project._id}" target="_blank" style="color: #D15F45">${ obj.project.projectId } - ${ obj.project.projectName }</a> 
...
function severalDr1reAssign(obj) {
	...
	return `<div class="wrapper" style="width:800px;border-width:1px;border-style:solid;border-color:rgb(129, 129, 129);font-family:'Roboto', sans-serif;color:#66563E;box-sizing:border-box;" >
                ...
                <div class="main" style="padding-top:20px;padding-bottom:20px;padding-right:20px;padding-left:20px;" >
                		<p style="background: #F4F0EE; font-size: 14px; font-weight: bold; padding: 14px;"><span id="client-name-row">Dear ${ obj.prevManager.firstName } ${  obj.prevManager.lastName || "" }</span></p>
                    <p style="font-width: 400;">
                        DR1 from project <a href="https://admin.pangea.global/projects/details/${obj.project._id}" target="_blank" style="color: #D15F45">${ obj.project.projectId } - ${ obj.project.projectName }</a> 
