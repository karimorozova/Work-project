...
function getPdfOfQuote(allUnits, allSettingsSteps, obj, tasksIds = []) {
	...
	const taskInfoSubTotal = tasksInfoArr.reduce((acc, curr) => acc + curr.cost, 0);
	const taskInfoWithoutDiscountsArr = obj.selectedTasks.length ?
			getTasksInfo(fromMinimumCharge, selectedTasks, obj.steps, allUnits, allSettingsSteps, true, true) :
			getTasksInfo(fromMinimumCharge, selectedTasks, obj.steps, allUnits, allSettingsSteps, true, true);
	const taskInfoWithoutDiscounts = taskInfoWithoutDiscountsArr.reduce((acc, curr) => acc + curr.cost, 0);
	total = !toIgnore ? (value > total ? value : (taskInfoSubTotal - (taskInfoSubTotal - taskInfoWithoutDiscounts)).toFixed(2)) : (taskInfoSubTotal - (taskInfoSubTotal - taskInfoWithoutDiscounts)).toFixed(2);
                ...
                <div class="quote__subheader" style="text-align:center;font-weight:bold;padding-top:15px;padding-bottom:15px;padding-right:0;padding-left:0;border-top-width:1px;border-top-style:solid;border-top-color:#66563D;" >
                    ${ obj.projectName }
	                       ...
	                       <table class="details__table"
	                            ...
	                            <tr>
	                                <td class="main_weight600"
	                                    style="color:#fff; background: #66563E; border-width:0px;border-style:solid;border-color:#66563E;padding-top:5px;padding-bottom:5px;padding-right:5px;padding-left:5px;font-weight:600;">
	                                    Service</td>
	                                <td class="main_weight600"
	                                    style="color:#fff; background: #66563E; border-width:0px;border-style:solid;border-color:#66563E;padding-top:5px;padding-bottom:5px;padding-right:5px;padding-left:5px;font-weight:600;">
	                                    Language</td>
	                        ...
	                        <table class="details__table"
	                            style="color:#66563E;width: 100%;border-width:0px;border-style:solid;border-color:#66563E;border-collapse:collapse;">
															${ generateSubTotalAndTMDiscountsRow(taskInfoSubTotal, taskInfoWithoutDiscounts, fromMinimumCharge) }
	                            ${ discountsRows(obj, taskInfoWithoutDiscounts, fromMinimumCharge) }
	                            <tr>
	                                <td class="main_weight600"
	                                    style="color:#fff; width: 88%; background: #66563E;border-width:0px;border-style:solid;border-color:#66563E;padding-top:5px;padding-bottom:5px;padding-right:5px;padding-left:5px;font-weight:600;">
	                                Total:</td>
	                                <td
	                                    style="color:#fff; background: #66563E;border-width:0px;border-style:solid;border-color:#66563E;padding-top:5px;padding-bottom:5px;padding-right:5px;padding-left:5px;font-weight:600;">
	                                    &euro; ${ total }</td>
...
function showCostHeader(fromMinimumCharge) {
	return !fromMinimumCharge ? `<td class="main_weight600" 
						style="color:#fff; width: 12%; background: #66563E; border-width:0px;border-style:solid;border-color:#66563E;padding-top:5px;padding-bottom:5px;padding-right:5px;padding-left:5px;font-weight:600;">
...
function getTaskCode(fromMinimumCharge, taskInfo) {
	return `<tr>
                ...
                <td
              	...
              	${ showCost(fromMinimumCharge) }
            </tr>`;

	function showCost(fromMinimumCharge) {
