...
function messageForClientSendQuote(obj, allUnits, allSettingsSteps) {
	...
	const tasksInfo = obj.selectedTasks.length ?
			getTasksInfo(obj.selectedTasks, obj.steps, allUnits, allSettingsSteps) :
			getTasksInfo(activeTasks, obj.steps, allUnits, allSettingsSteps);
	const tasksInfoArr = obj.selectedTasks.length ?
			getTasksInfo(obj.selectedTasks, obj.steps, allUnits, allSettingsSteps, true) :
			getTasksInfo(activeTasks, obj.steps, allUnits, allSettingsSteps, true);
	...
	const taskInfoWithoutDiscountsArr = obj.selectedTasks.length ?
			getTasksInfo(obj.selectedTasks, obj.steps, allUnits, allSettingsSteps, true, true) :
			getTasksInfo(activeTasks, obj.steps, allUnits, allSettingsSteps, true, true);
	const taskInfoWithoutDiscounts = taskInfoWithoutDiscountsArr.reduce((acc, curr) => acc + curr.cost, 0);
	const discounts = obj.discounts.length ?
	...
	let colorMinRow = (obj.discounts.length) % 2 ? '#fff' : '#F4F0EE';
	const minRow = fromMinimumCharge ?
			`<tr>
            <td class="main_weight600"
                style="border:none;background:${ colorMinRow };padding-top:5px;padding-bottom:5px;padding-right:5px;padding-left:5px;font-weight:600;">
                Minimum:</td>
            <td style="border:none;background:${ colorMinRow };padding-top:5px;padding-bottom:5px;padding-right:5px;padding-left:5px;">
                &euro; ${ value.toFixed(2) }</td>
      </tr>` : `<tr style="display: none;"></tr>`;

	total = !toIgnore ? (value > total ? value : (taskInfoSubTotal - (taskInfoSubTotal - taskInfoWithoutDiscounts)).toFixed(2)) : (taskInfoSubTotal - (taskInfoSubTotal - taskInfoWithoutDiscounts)).toFixed(2);
	...
	return `<div class="wrapper"
                ...
                <div class="main" style="padding-top:40px;padding-bottom:40px;padding-right:40px;padding-left:40px;">
                    ...
                    <div class="details" style="width:95%;margin-top:0;margin-bottom:15px;margin-right:auto;margin-left:auto;">
                        ...
                        <table class="details__table"
                            style="color:#66563E;width: 50%;border-width:1px;border-style:solid;border-color:#66563E;border-collapse:collapse;">
                            <tr>
                                <td class="main_weight600"
...
function getPdfOfQuote(allUnits, allSettingsSteps, obj, tasksIds = []) {
	...
	const tasksInfo = getTasksInfo(selectedTasks, obj.steps, allUnits, allSettingsSteps);
	const tasksInfoArr = getTasksInfo(selectedTasks, obj.steps, allUnits, allSettingsSteps, true);
	const taskInfoSubTotal = tasksInfoArr.reduce((acc, curr) => acc + curr.cost, 0);
	...
	return `<div class="wrapper pdf" style="width:800px; margin: 0 auto; font-size:14px!important;border-width:1px;border-style:solid;border-color:rgb(129, 129, 129);font-family:'Roboto', sans-serif;color:#66563E;box-sizing:border-box;" >
                ...
                <div class="quote__subheader" style="text-align:center;font-weight:bold;padding-top:15px;padding-bottom:15px;padding-right:0;padding-left:0;border-top-width:1px;border-top-style:solid;border-top-color:#66563D;" >
                    ${ obj.projectName }
                       ...
                       <table class="details__table"
                            style="width:100%;color:#66563E;border-width:0px;border-style:solid;border-color:#66563E;border-collapse:collapse;">
                            <tr>
                                <td class="main_weight600"
                                    style="color:#fff; background: #66563E; border-width:1px;border-style:solid;border-color:#66563E;padding-top:5px;padding-bottom:5px;padding-right:5px;padding-left:5px;font-weight:600;">
                                    Service</td>
...
function getTasksInfo(tasks, steps, allUnits, allSettingsSteps, onlyInformation = false, sumForTMDiscounts = false) {
