...
function getPdfOfQuote(project, tasksIds, allUnits, allSettingsSteps) {
	...
	return `<div class="wrapper" style="width:800px;font-size:14px!important;border-width:1px;border-style:solid;border-color:#bfbfbf;font-family:'Roboto', sans-serif;color:#333!important;box-sizing:border-box;" >
                <header style="background-color:#efefef;text-align:center; padding: 10px 0;" >
