...
const industriesDefault = [
    ...
    {name: 'Medical Devices', rate: 0,  icon: '/static/industries/more-icon.png', generic: '/static/example.xlsx', active: true},
    ...
    {name: 'E-Learning', rate: 0,  icon: '/static/industries/more-icon.png', generic: '/static/example.xlsx', active: true},
    {name: 'Pharma', rate: 0,  icon: '/static/industries/more-icon.png', generic: '/static/example.xlsx', active: true},
    {name: 'Websites, Apps & Platforms', rate: 0, icon: '/static/industries/casino-poker-igaming.png', generic: '/static/example.xlsx', active: true},
    {name: 'Museums & Tourist Attractions', rate: 0, icon: '/static/industries/casino-poker-igaming.png', generic: '/static/example.xlsx', active: true},
    {name: 'eSport', rate: 0, icon: '/static/industries/casino-poker-igaming.png', generic: '/static/example.xlsx', active: true},
    {name: 'Sports Betting', rate: 0, icon: '/static/industries/casino-poker-igaming.png', generic: '/static/example.xlsx', active: true},
    {name: 'Finance', rate: 0, icon: '/static/industries/casino-poker-igaming.png', generic: '/static/example.xlsx', active: true},
