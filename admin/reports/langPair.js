 ...
 * @returns {Array} - returns array report
 */
async function getLangPairReport(projects) {
  const finance = ["CFDs & Online Trading", "Finance"];
 ...
 * @param {Array} langs
 * @param {Array} projects
 * @param {Array} financeIndustries
 * @param {Array} gameIndustries
 * @returns {Array} returns assembled report
 */
 ...
 * @returns {Object} - returns object with calculated wordcount and assembled clients
 */
