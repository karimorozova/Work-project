<template lang="pug">
    .clients-wrap
        .buttons
            input.buttons__button(type="button" value="Save")
            input.buttons__button(type="button" value="Cancel" @click="cancel")
            input.buttons__button(type="button" value="Delete")
