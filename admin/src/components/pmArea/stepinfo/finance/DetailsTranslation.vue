  ...
  .details
    ...
    .table__tbody.tbody_visible-overflow
      .table__body-row
        ...
        .table__tbody-cell(v-if="!isQuantityEditable &&  financeData.vendor") {{ financeData.payables.quantityTotal }}
      ...
      .table__body-row
        ...
        .table__tbody-cell(v-if="!isQuantityEditable &&  financeData.vendor") {{ financeData.payables.quantityRelative }}
        .table__tbody-cell(v-else-if="!financeData.vendor")
