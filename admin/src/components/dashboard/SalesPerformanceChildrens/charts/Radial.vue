<template>
    <div class="radial">
        ...
        <svg  xmlns="http://www.w3.org/2000/svg" height="150" width="150" viewBox="0 0 240 240" data-value="40">
            ...
            <path mask="url(#mask2)" fill="none" stroke-width="22" stroke="#d66f58" d="M41 149.5a77 77 0 1 1 117.93 0" class="meter" :pathLength="total" :stroke-dasharray="strokeDashArray">
