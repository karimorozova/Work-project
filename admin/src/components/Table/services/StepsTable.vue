  ...
  .steps
    .table
      GeneralTable(
        ...
        //.table__data.table_centered(slot="stage1" slot-scope="{ row, index }" :class="{'table_active': currentActive === index}")
        //    img.table__checkbox(v-if="isSelected('isStage1', index)" src="../../../assets/images/latest-version/checkbox-brown-1.png" @click="toggleActive(index, 'isStage1')" :class="{'table_opacity': currentActive === index}")
        //    img.table__checkbox(v-else src="../../../assets/images/latest-version/checkbox-brown-0.png" @click="toggleActive(index, 'isStage1')" :class="{'table_opacity': currentActive === index}")
        //.table__data.table_centered(slot="stage2" slot-scope="{ row, index }" :class="{'table_active': currentActive === index}")
        //    img.table__checkbox(v-if="isSelected('isStage2', index)" src="../../../assets/images/latest-version/checkbox-brown-1.png" @click="toggleActive(index, 'isStage2')" :class="{'table_opacity': currentActive === index}")
        //    img.table__checkbox(v-else src="../../../assets/images/latest-version/checkbox-brown-0.png" @click="toggleActive(index,'isStage2')" :class="{'table_opacity': currentActive === index}")
...
export default {
  ...
  data() {
    return {
      fields: [
        { label: "Title", headerKey: "headerTitle", key: "title", style: { width: "30%" } },
        { label: "Calculation Unit", headerKey: "headerUnit", key: "calculationUnit", style: { width: "45%" } },
