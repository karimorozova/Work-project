...
export const getAllLanguages = state => state.allLanguages;
export const getAllIndustries = state => state.allIndustries;
export const getAllSteps = state => state.allSteps;
export const getAllUnits = state => state.allUnits;
export const getAllServices = state => state.allServices;
